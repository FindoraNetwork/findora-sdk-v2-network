...
var getQueryRoute = function () {
    var _a = environment_1.Environment.config, hostUrl = _a.hostUrl, queryPort = _a.queryPort;
...
var getConfig = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, configServerUrl, dataResult;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = environment_1.Environment.config.configServerUrl, configServerUrl = _a === void 0 ? findora_sdk_v2_core_1.Sdk.environment.configServerUrl : _a;
