...
export declare const getTxList: (subject: string, type: 'to' | 'from', page?: number, privacy?: 'transparent' | 'anonymous', config?: Types.NetworkAxiosConfig) => Promise<Types.TxListDataResult>;
